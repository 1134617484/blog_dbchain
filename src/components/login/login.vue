    ...
    return {
      ...
      options: [
        ...
        },
        {
          ...
          name: "张三",
          mnemonic:
            "fuel lamp canal lazy barrel medal scheme coconut brass slender tackle satoshi",
          password: "123456",
          key: "",
        },
        {
          ...
          name: "张四",
          mnemonic:
            "cross dirt blouse sheriff option system enemy anchor flight desk employ essay",
          password: "123456",
          key: "",
        },
        {
          ...
          name: "张五",
          mnemonic:
            "cereal orient close profit else usual dizzy abandon rib doctor inner story",
          password: "123456",
          key: "",
        },
        {
          ...
          name: "张六",
          mnemonic:
            "remember chicken impulse marine rose oak gate result cruise glad cup lazy",
          password: "123456",
          key: "",
        },
      ],
